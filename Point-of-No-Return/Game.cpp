...
void Game::Draw()
{
	...
	drawmap.DrawMapChip(world_size_width, world_size_height, texture_width, texture_height, chip_width_num, chip_height_num, chip_size_, chip_size_, 0, 0, "blocks", drawmap.map_);
}
